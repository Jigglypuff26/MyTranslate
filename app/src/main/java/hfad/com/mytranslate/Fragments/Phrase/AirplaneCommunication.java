...
public class AirplaneCommunication extends Fragment implements View.OnClickListener  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.airplane_communication, container, false);
    ...
    private void loadDatainViewn() {
        Phrase_array = phrases_sql.getCategotyAirplaneCommunication();
