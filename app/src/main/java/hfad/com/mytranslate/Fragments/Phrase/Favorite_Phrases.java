...
public class Favorite_Phrases extends Fragment implements View.OnClickListener  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.favorite_phrases, container, false);
    ...
    private void loadDatainViewn() {
        Phrase_array = phrases_sql.getCategotyFavorite_Phrases();
