...
public class CommunicationCity extends Fragment implements View.OnClickListener  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.communication_city, container, false);
    ...
    private void loadDatainViewn() {
        ...
        Phrase_array = phrases_sql.getCategotyCommunicationCity();
