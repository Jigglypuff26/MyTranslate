...
public class Auto_chat extends Fragment implements View.OnClickListener  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =  inflater.inflate(R.layout.auto_chat_fragment, container, false);
    ...
    private void loadDatainViewn() {
        Phrase_array = phrases_sql.getCategotyAuto_chat();
